...
# Entrada do usuário
intensidade_feitico = int(input("Feitiço: "))
componente_raro_feitico = input("Componente raro: ")
fase_lunar_feitico = input("Fase lunar: ")
idade_feiticeiro = int(input ("Idade do feiticeiro: "))
afinidade_animais_feiticeiro = input("Afinidade com animais: ")
